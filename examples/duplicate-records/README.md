# Duplicate DNS records example

This example creates a public hosted zone and two CNAME records that share the same name, as used for ACM SAN certificate validation. It calls the root module from `examples/duplicate-records/main.tf`.
...
| <a name="input_zones"></a> [zones](#input\_zones) | Map of Route53 zone parameters | `map(any)` | n/a | yes |
