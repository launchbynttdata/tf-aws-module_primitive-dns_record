# Zone records example

This example creates a public hosted zone with an A record and a CNAME record. It calls the root module from `examples/zone-records/main.tf`.
